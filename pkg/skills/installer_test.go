...
func TestParseGitHubRef(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			repo:         "https://github.com/kuzmichus/neoclaw/tree/dev/skills/test",
			wantOwner:    "kuzmichus",
			wantRepoName: "neoclaw",
			wantRef:      "dev",
			wantSubPath:  "skills/test",
		},
		{
			name:         "full URL with blob",
			repo:         "https://github.com/kuzmichus/neoclaw/blob/main/README.md",
			wantOwner:    "kuzmichus",
			wantRepoName: "neoclaw",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/kuzmichus/neoclaw",
			wantOwner:    "kuzmichus",
			wantRepoName: "neoclaw",
			wantRef:      "main",
			wantSubPath:  "",
