...
2. Store the actual token using one of these methods:
   ...
   - **Secure storage**: Use NeoClaw's secure token storage mechanism
...
1. Add the token to your NeoClaw configuration
...
VK has a maximum message length of 4000 characters. NeoClaw automatically splits longer messages into multiple parts.
...
4. Check NeoClaw logs for error messages
