...
NeoClaw provides QQ support via the official Bot API from the QQ Open Platform.
...
3. Fill in the credentials in the NeoClaw configuration file
...
4. Fill in the credentials in the NeoClaw configuration file
