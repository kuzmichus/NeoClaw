...
Slack est l'une des principales plateformes de messagerie instantanée pour les entreprises. NeoClaw utilise le Socket Mode de Slack pour une communication bidirectionnelle en temps réel, sans nécessiter la configuration d'un endpoint webhook public.
