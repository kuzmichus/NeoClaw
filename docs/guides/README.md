...
Task-oriented guides for setup, configuration, and common NeoClaw workflows.

- [Docker & Quick Start Guide](docker.md): install and run NeoClaw with Docker or the launcher.
- [Android Termux Guide](android-termux.md): run the NeoClaw terminal binary on an ARM64 Android phone.
...
- [NeoClaw Hardware Compatibility List](hardware-compatibility.md): tested boards and platform notes.
- [Using Antigravity Provider in NeoClaw](ANTIGRAVITY_USAGE.md): Google Cloud Code Assist setup and usage.
