...
# Sử dụng nhà cung cấp Antigravity trong NeoClaw

Hướng dẫn này giải thích cách thiết lập và sử dụng nhà cung cấp **Antigravity** (Google Cloud Code Assist) trong NeoClaw.
...
6.  **Dán nó vào terminal** nơi NeoClaw đang chờ.

NeoClaw sẽ tự động trích xuất mã ủy quyền và hoàn tất quy trình.
...
*   **429 Giới hạn tốc độ**: Antigravity có hạn mức nghiêm ngặt. NeoClaw sẽ hiển thị "thời gian đặt lại" trong thông báo lỗi nếu bạn đạt đến giới hạn.
